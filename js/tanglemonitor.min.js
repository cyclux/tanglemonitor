...
c.addEventListener("mousemove",function(a){25<Date.now()-rateLimiter&&(mousePos=GetMousePos(c,a),txOfMousePosition=GetTXofMousePosition(mousePos),txOfMousePosition.hash?(a=_.round((txOfMousePosition.ctime-txOfMousePosition.time)/60,2),a=txOfMousePosition.confirmed?a+" Minutes":txOfMousePosition.reattached?"Reattached transaction":"Not confirmed yet",tooltip.innerHTML="Address: "+txOfMousePosition.address+"<br>TX Hash: "+txOfMousePosition.hash+"<br>Confirmation Time: "+a,selectedAddress=txOfMousePosition.address,
